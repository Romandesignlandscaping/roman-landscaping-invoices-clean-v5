...
function defaultState() {
  ...
  return {
    ...
    settings: {
      ...
      promoImage: '/assets/promo-default-v5.png',
      headerLogo: '/assets/header-logo-v5.png',
      defaultDueDays: 14,
      compactView: false,
...
async function warmImages() {
  const paths = ['/assets/header-logo-v5.png', '/assets/promo-default-v5.png'];
    ...
    <div class="app-shell">
      <header class="topbar">
        <div class="brand-wrap">
          <div class="brand-side"><img src="/assets/header-logo-v5.png" alt="Roman logo"></div>
  ...
  return `
    ...
    <section class="grid-2">
      ...
      <div class="section-card">
        ...
        <div class="preview-box"><img id="promoPreview" src="${state.settings.promoImage || '/assets/promo-default-v5.png'}" alt="Promo preview"></div>
...
function createInvoiceSnapshot(invoice) {
  ...
  return {
    ...
    promoImage: state.settings.promoImage || '/assets/promo-default-v5.png',
    headerLogo: state.settings.headerLogo || '/assets/header-logo-v5.png',
...
async function generateInvoicePdf(invoice, { download = true, doc = null, addPage = false } = {}) {
  ...
  const headerLogoPath = snap.headerLogo || state.settings.headerLogo || '/assets/header-logo-v5.png';
  const headerLogo = headerLogoPath?.startsWith('data:') ? headerLogoPath : await loadImageAsDataUrl(headerLogoPath);
  const promoPath = snap.promoImage || state.settings.promoImage || '/assets/promo-default-v5.png';
